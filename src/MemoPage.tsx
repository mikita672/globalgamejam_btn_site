    ...
    return (
        <div className="memo-page">
            ...
            <div className="memo-decorative-elements">
                <img src={tree1} alt="" className="memo-decorative-element memo-tree-1" />
                <img src={tree2} alt="" className="memo-decorative-element memo-tree-2" />
                <img src={bush1} alt="" className="memo-decorative-element memo-bush-1" />
                <img src={bush2} alt="" className="memo-decorative-element memo-bush-2" />
            </div>
            ...
            <div className="memo-content">
                ...
                <div className="memo-stats">
                    ...
                    <span className="memo-stat">Pairs: {matchedPairs}/{PAIRS_COUNT}</span>
                </div>
                    ...
                    {cards.map((card) => (
                        ...
                        >
                            <div className="memo-card-inner">
                                ...
                                <div className={`memo-card-front ${card.isObfuscated ? "obfuscated" : "normal"}`}>
                                    {card.letter}
                                </div>
                            </div>
                        </div>
