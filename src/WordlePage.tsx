...
import painting2 from "./assets/Painting6.png";
    ...
    return (
      <div className="wordle-page">
        <div className="wordle-content">
          ...
          <p style={{ fontFamily: "NormalFont", fontSize: "1.2rem" }}>
            Loading word...
          </p>
        </div>
      </div>
  ...
  return (
    <div className="wordle-page">
      ...
      <div className="decorative-elements">
        ...
        <img src={painting1} alt="" className="decorative-element painting-1" />
        <img src={painting2} alt="" className="decorative-element painting-2" />
      </div>
